...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    ...
                    <?php if (session()->get('role') != 'employee') : ?>
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#categoryDate">
                            Export Laporan
                        </button>
                    <?php endif ?>
                </div>
            ...
            <?= $this->include('pages/partials/modalCategory') ?>
            <div class="card-body">
...
<script>
    document.getElementById('exportBtn').addEventListener('click', function() {
        ...
        var url = `${base_url}dashboard/data/laba/export/${startDate}/${endDate}/${category}`
